...
\affil[1]{Windstorm Institute, Fort Ann, NY 12827, USA}
\affil[ ]{\texttt{ORCID: 0009-0007-3224-755X}}

\date{Version 1.3 \\ May 2026}
...
\begin{tabular}{rrrrr}
\toprule
$d_1$ & $\Delta S_{\mathrm{EE}}$ & $\Delta E_A$ & $2\pi d_1 \Delta E_A$ & $\Delta S_{\mathrm{EE}}/\mathrm{bound}$ \\
\midrule
...
\subsubsection{Boost-generator equality verification}

To verify the BW identification (Step 1 of Theorem~\ref{thm:escrow}), we compare the modular Hamiltonian expectation computed two ways: via the lattice modular Hamiltonian (Williamson decomposition) versus via direct evaluation of the boost generator $K^{\mathrm{boost}}_A = 2\pi \sum_{i \in A} (i - \mathrm{cut}) \cdot T_{00}(i)$.
...
\bottomrule
\end{tabular}
\caption{Boost-generator equality verification. Mean ratio $0.99913 \pm 0.00122$ across 10 parameter combinations. This validates Step 1 of Theorem~\ref{thm:escrow} (BW identification of the boost generator with the continuum modular Hamiltonian).}
\label{tab:boost}
\end{table}
...
\item \textbf{Boost-generator equality violation:} Discovery of a parameter regime in which $\Delta\langle K^{\mathrm{boost}}_A\rangle / (2\pi d \Delta E_A)$ deviates substantially from unity in continuum BW theory.
\end{enumerate}
...
\item Is anchored by first-principles lattice computation that reproduces the BW identity within lattice-discretization precision in the Rindler-wedge sector.
\end{itemize}
...
\item \textbf{Analog-gravity empirical tests.} \cite{Whitmer2026Phonon} derives a complementary non-equilibrium efficiency bound for Bose-Einstein condensate analog gravity, predicting a 17\% efficiency suppression in BEC phonon extraction. While that bound arises from Verlinde-based non-equilibrium thermodynamics rather than from the static escrow recipe of the present work, both belong to the same family of thermodynamic-bound constructions and a unified treatment would strengthen the empirical foundation of the framework.
...
The framework's specific empirical claim is the inequality of Theorem~\ref{thm:escrow} — the escrow form of the Casini--Bisognano--Wichmann bound, with the escrow postulate identifying the right-hand side. Direct lattice computation verifies the inequality across mass-perturbation and Compton-wavepacket protocols; the underlying BW identity is reproduced within lattice-discretization precision ($\sim 0.1\%$) and the bound itself is generally loose (maximum $5.4\%$ saturation observed).
...
\href{https://doi.org/10.5281/zenodo.20014391}{DOI: 10.5281/zenodo.20014391}.
...
\href{https://doi.org/10.5281/zenodo.20032023}{DOI: 10.5281/zenodo.20032023}.
...
Windstorm Institute, Fort Ann, NY (May 2026).
\href{https://doi.org/10.5281/zenodo.20041992}{DOI: 10.5281/zenodo.20041992}.

\bibitem{Whitmer2026Lattice}
G. L. Whitmer III, ``A Lattice Quantum Field Theory Test of the Static Escrow Postulate: 1+1D and 3+1D Falsification with Modular-Hamiltonian Partial Survival,'' v0.7,
Windstorm Institute, Fort Ann, NY (May 2026).
\href{https://doi.org/10.5281/zenodo.20057538}{DOI: 10.5281/zenodo.20057538}.
...
Windstorm Institute, Fort Ann, NY (May 2026).
\href{https://doi.org/10.5281/zenodo.20126091}{DOI: 10.5281/zenodo.20126091}.
